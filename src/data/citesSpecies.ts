...
// CITES Annexe I A - Espèces les plus menacées
export const citesAnnexIASpecies: ReptileSpecies[] = [
  // Serpents protégés - À compléter selon les besoins
  {
...
// CITES Annexe II B - Espèces surveillées
export const citesAnnexIIBSpecies: ReptileSpecies[] = [
  // Serpents (Snakes)
  {
    id: 'python-regius',
...
export const citesAnnexIISpecies = citesAnnexIIBSpecies;

export const getAllSpecies = () => {
  return [...citesAnnexIASpecies, ...citesAnnexIIBSpecies];
};
...
export const getSpeciesByAnnex = (annex: 'IA' | 'IIB') => {
  if (annex === 'IA') return citesAnnexIASpecies.filter(s => s.category === 'snake');
  return citesAnnexIIBSpecies.filter(s => s.category === 'snake');
};
