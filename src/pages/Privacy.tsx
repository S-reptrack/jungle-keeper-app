...
const Privacy = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Politique de confidentialité — S-reptrack"
        description="Politique de confidentialité de S-reptrack : données personnelles, RGPD, cookies, droits des utilisateurs."
        canonical="/privacy"
      />
